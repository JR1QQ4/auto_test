...
public class CaseUtil {
    ...
    static {
        // ExcelUtil.load("src/main/resources/baiduInterface_v4.xlsx", "Cases", Case.class);

        List<Case> caseList = ExcelUtil.loadPlus(PropertiesUtil.getExcelOath(), "Cases", Case.class);
